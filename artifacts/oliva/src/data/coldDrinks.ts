...
export const coldDrinks: ColdDrink[] = [
  {
    ...
    image: '/images/products/IcedSpanishLatte.jpg',
    themeColor: '#0d2240',
    flavors: ['Classic'],
  },
  {
    ...
    price: '$3.50',
    lbpPrice: '400,000 LBP',
    image: '/images/products/IcedMochaLatte.jpg',
    themeColor: '#15102a',
  ...
  },
  {
    ...
    image: '/images/products/IcedMatcha Latte.jpg',
    themeColor: '#0e1f35',
  ...
  },
  {
    ...
    price: '$3.50',
    lbpPrice: '300,000 LBP',
    image: '/images/products/IrishCreamLatte.jpg',
    themeColor: '#1a1208',
    flavors: ['Classic'],
  },
  {
    ...
    price: '$3.50',
    lbpPrice: '300,000 LBP',
    image: '/images/products/CaramelMacchiato.jpg',
    themeColor: '#2a1c08',
    flavors: ['Classic'],
  },
  {
    ...
    image: '/images/products/IcedMatchaLatte.jpg',
    themeColor: '#09261a',
