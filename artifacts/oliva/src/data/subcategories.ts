...
export const coldDrinksSubcategories: Subcategory[] = [
  ...
  },
  {
    ...
    drinks: [
      ...
      { name: 'Peach Iced Tea', description: 'Refreshing peach iced tea.', price: '$3', lbpPrice: '300,000 LBP', image: '/images/products/PeachIcedTea.png', recipe: 'Black tea · Peach flavor · Light sweetener · Ice' },
